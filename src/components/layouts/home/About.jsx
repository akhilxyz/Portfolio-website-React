                ...
                <div className="d-lg-flex">
                    <div className="col-left">
                        <div className="featured-post animate-element wow delay5 fadeInUp" data-wow-delay="0.5s">
                            <img src="images/section/a1.png" alt="images"/>
                        </div>
                    </div>
                    <div className="col-right">
                        ...
                        <div className="flat-title t1">
                            <div className="animate-element wow delay5 fadeInDown" data-wow-delay="0.5s">
                                ...
                                <p>
                                    Hi, if you need  Website, Progressive Web Application, Blockchain Applications, Machine Learning Models or Graphics Designs within a week or days? then you can tell me, I'm here to help you. I can make any kind of Software and Website. Check my portfolio.
                                </p>
                            </div>
