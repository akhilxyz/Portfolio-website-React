            ...
            design : [
                {
                    ...
                    text01: "I'm a professional Frontend & Backend developer",
                    text02: 'My main focus is on Design and Code'
                },
                {
                    id: 2,
                    ...
                    spanicon: 'icon-designer',
                    title: 'Blockchain',
                    text01: "I'm a Bloackchain Developer. I've Worked on Decentralized  ",
                    text02: 'applications, Smart Contracts, JSON-RPC, Ethereum Web3.'
                },
                {
                    id: 3,
                    ...
                    text01: "I'm a professional Graphic designer I can design any kind",
                    text02: ' of MokeUp, Banner, Logo Covers etc.'
                },
            ]
        }
    }
                        ...
                        <div className="row position-relative z-index1">
                            ...
                            <div className="fact">
                                ...
                                <div className="btn-contact bg-s1 text-center">
                                    ...
                                    <Link to="#" className="email color-s1 color-d14">akhilchoudharyxyz@gmail.com</Link>
                                </div>
                            </div>
