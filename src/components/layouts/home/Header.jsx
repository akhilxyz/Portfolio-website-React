                ...
                <div className="container">
                    <div className="flex-header d-flex justify-content-between align-items-center">
                        <div className="socials-list-hd s1 hv1">
                            <a href="https://www.facebook.com/Itsyourboyakhil"><i className="fa fa-facebook" aria-hidden="true" /> </a>
                            <a href="https://www.facebook.com/Itsyourboyakhil"><i className="fa fa-twitter" aria-hidden="true" /> </a>
                            <a href="https://www.facebook.com/Itsyourboyakhil"><i className="fa fa-instagram" aria-hidden="true" /> </a>
                        </div>
